...
\section{Constant Transaction Cost}
Let the constant transaction cost be $\lambda$ (buying cost) and $\mu$ (selling cost). Since the profit (cost) of selling (buying) one unit at the same price level is the same, the optimal strategy should be bang-bang. Define the following two value functions.
